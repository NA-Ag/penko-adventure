...
export const PROMPTS = {
    af, am, ar, az, bg, bn, bo, ca, cs, cy, da, de, el, en, es, et, eu, fa, ff, fi, fr, ga, gd, gl, gu, ha, haw, he, hi, hr, ht, hu, hy, id, ig, is, it, ja, jv, ka, kk, km, kn, ko, ku, la, lo, ml, mn, mr, ms, my, nl, no, nv, ny, om, or, pa, pl, ps, pt, ro, ru, rw, sd, si, sk, so, sq, sr, st, su, sv, sw, ta, te, tg, th, tl, tr, uk, ur, uz, vi, wuu, yi, yo, yue, zh, zu,
    utility
